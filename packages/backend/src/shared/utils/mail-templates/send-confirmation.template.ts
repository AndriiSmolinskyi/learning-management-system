...
export const sendEmailConfirmationTemplate = (
    ...
    <body style="font-family: 'Segoe UI', sans-serif; font-size: 13px;">
        ...
        <p>Dear ${body.name},</p>
			<p>Welcome to Migdal Management Analytics — your all-in-one assets consolidation platform.</p>
			...
			<p>For any support, feel free to contact Migdal Management's back office directly.</p>
			<p>We are confident that our platform will be a valuable asset to you.</p>
			<p>Thank you for your trust!</p>
			<p>Sincerely,</p>
			<p>Migdal Management Team</p>
    </body>

    </html>`

	const mail = {
		subject: 'Welcome to Migdal Management Analytics !',
		html,
	}
