...
export const labelColor = (cashFlow?: string,): string => {
	return css`
  background: ${cashFlow === TransactionCashFlow.INFLOW ?
		'#2236F3B2' :
		'#70707BB2'};
  border: 1px solid ${cashFlow === TransactionCashFlow.INFLOW ?
		'var(--primary-200)' :
		'var(--gray-200)'};
	border-radius: 16px;
...
export const labelColorProfit = (pl?: string,): string => {
	return css`
  border-radius: 16px;
  display: inline-block;
  padding: 2px 8px;
