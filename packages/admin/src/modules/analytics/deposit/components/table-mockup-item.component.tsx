	...
	return (
		<tr className={styles.tableMockupRow()}>
			...
			<td className={cx(styles.tableCell, styles.tableNumberField,)}>
				{localeString(Number(parsedPayload.currencyValue,), '', 0, false,)}
			</td>
			<td className={cx(styles.tableCell, styles.tableNumberField,)}>N/A</td>
			<td className={cx(styles.tableCell, styles.tableNumberField,)}>
				{localeString(Number(parsedPayload.interest,),)}%
			</td>
			<td className={styles.tableCell}>{parsedPayload.policy}</td>
		</tr>
	)
}
