...
import {
	TOverviewSortVariants, type TOverviewTableFilter,
} from '../overview.types'
import {
	SortOrder,
} from '../../../../shared/types'
...
export const AssetTableHeader: React.FC<Props> = ({
	filter,
	isTbodyEmpty,
	assetCombinedFilter,
	setFilter,
	...
	return (
		<div className={styles.smallTableHead(isTbodyEmpty,)}>
			<p className={styles.smallHeaderCell}>Asset type</p>
			<p className={styles.smallHeaderCellNumber}>{assetCombinedFilter?.currencies?.length === 1 && 'Currency FC'}</p>
