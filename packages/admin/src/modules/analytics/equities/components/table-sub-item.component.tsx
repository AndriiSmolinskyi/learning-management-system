...
export const TableSubItem: React.FC<Props> = ({
	...
	return (
		...
		>
			...
			<td className={styles.tableCell}>
				<div className={styles.cellContent}>{row.isin}</div>
			</td>
			<td className={styles.tableCellMinimized}>
				<div className={styles.cellContent}>{row.security}</div>
			</td>
			<td className={styles.tableCellMinimized}>{row.currency}</td>
			<td className={cx(styles.tableCellMinimized, styles.tableNumberField, styles.amountColor(row.operation === AssetOperationType.BUY,),)}>{row.operation === AssetOperationType.BUY ?
