...
export const cellWidth125 = css`
	min-width: 125px;
	/* width: 125px; */
`

export const cellWidth135 = css`
	min-width: 135px;
	/* width: 135px; */
`
...
export const chartByWalletsContainer = css`
	min-height: 0;
	height: 100%;
	border-radius: 22px;
	background-color: var(--base-white);
...
export const tableBtnContainer = (isHorizontalScroll: boolean, isNothing?: boolean,): string => {
	return css`
	position: absolute;
	display: flex;
	align-items: center;
...
export const paddingRight16px = css`
	padding-right: 16px;
`
