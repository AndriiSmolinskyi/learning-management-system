...
export const LoanDetails: React.FC<IAssetDrawerProps> = ({
	asset,
},) => {
	...
	return (
		<div className={styles.drawerContent}>
			...
			<div className={styles.drawerItemBorder}>
				{renderField('Loan name', parsedPayload.loanName,)}
				...
				{renderField('Interest', formatWithAllDecimals(Number(parsedPayload.interest,),),)}
				{renderField('Interest today',formatWithAllDecimals(parsedPayload.todayInterest,),)}
				{renderField('Interest to maturity', formatWithAllDecimals(parsedPayload.maturityInterest,), hasComment,)}
