...
import {
	BarInputBlock,
} from './horizontal-bar-input-block.component'
...
type Props = {
	setEditHorizontalChartVisible: React.Dispatch<React.SetStateAction<boolean>>
}

export const HorizontalBarChartConstructor: React.FC<Props> = ({
	setEditHorizontalChartVisible,
},) => {
	const {
		barContent,
		setBarContent,
	...
	return (
		<div className={styles.builder}>
			...
			<div className={styles.constructorContent}>
				...
				<div>
					<div className={styles.horizontalHeadWrapper}>
						<div>
							<p>Label</p>
						</div>
						<div>
